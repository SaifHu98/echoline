...
const FALLBACK_EN := {
	...
	"menu.multiplayer": "MULTIPLAYER LOBBY",
	"menu.eyebrow": "THE FRACTURE IS WAKING",
	"menu.hero_title": "Your choices echo through every timeline.",
	"menu.hero_copy": "Play alone with your Echo companions or invite friends into a living mystery.",
	"menu.play_section": "CHOOSE YOUR JOURNEY",
	"menu.online": "Online · Ready to play",
	"menu.offline": "Offline mode · Solo story available",
	"menu.connecting": "Connecting to the Echo network…",
	"tutorial.intro": "Every action creates an Echo. Work together across Past, Present, and Future before stability reaches zero.",
	"tutorial.step1.title": "Choose a timeline",
	"tutorial.step1.body": "Past remembers, Present repairs, and Future predicts. Each path reveals a different clue.",
	"tutorial.step2.title": "Follow the Echo",
	"tutorial.step2.body": "Look for a glowing interaction, read its consequence, and communicate what changed.",
	"tutorial.step3.title": "Collect the shard",
	"tutorial.step3.body": "Resolved Echoes reveal Memory Shards. Keep the right shard for the right Anchor slot.",
	"tutorial.step4.title": "Build the Anchor",
	"tutorial.step4.body": "Place compatible shards in order. Late actions can change another timeline several moments later.",
	"tutorial.step5.title": "Protect stability",
	"tutorial.step5.body": "Use hints, quick chat, and pings when the catastrophe meter turns critical.",
	"common.got_it": "I'M READY",
	"settings.audio": "AUDIO",
	"settings.master": "Master volume",
	"settings.music": "Music",
	"settings.sfx": "Sound effects",
	"settings.ambient": "Ambient",
	"settings.gameplay": "GAMEPLAY & ACCESSIBILITY",
	...
	"lobby.subtitle": "Gather your crew. Choose your era. Change the future.",
	"lobby.join_title": "ENTER A ROOM",
	"lobby.open_rooms": "OPEN ROOMS",
	"story.title": "THE LAST CHIME",
	"story.subtitle": "A long-form journey across twelve fractured chapters",
	"story.intro": "A city is losing its memories. Walk through the fracture, solve its mysteries, and decide what deserves to survive.",
	"story.chapters": "CHAPTER SELECT",
	"story.journal": "ACTIVE CHAPTER JOURNAL",
	"story.begin": "BEGIN CHAPTER",
	"story.progress": "Progress: {done}/{total}",
	"story.objectives": "CHAPTER OBJECTIVES",
	"story.echoes": "Echoes recorded: {count}",
	"story.return": "RETURN TO JOURNEY"
}
...
const FALLBACK_AR := {
	...
	"credits.title": "⭐  الفضل",
	"menu.story": "طور القصة",
	"menu.multiplayer": "الردهة الجماعية",
	"menu.eyebrow": "الشق الزمني يستيقظ",
	"menu.hero_title": "اختياراتك تترك صدى في كل خط زمني.",
	"menu.hero_copy": "العب منفرداً مع رفاق الصدى أو ادعُ أصدقاءك إلى لغز حي.",
	"menu.play_section": "اختر رحلتك",
	"menu.online": "متصل · جاهز للعب",
	"menu.offline": "النمط غير المتصل · طور القصة متاح",
	"menu.connecting": "جاري الاتصال بشبكة الصدى…",
	"tutorial.intro": "كل فعل يصنع صدى. تعاون عبر الماضي والحاضر والمستقبل قبل أن يصل الاستقرار إلى الصفر.",
	"tutorial.step1.title": "اختر خطاً زمنياً",
	"tutorial.step1.body": "الماضي يتذكر، الحاضر يصلح، والمستقبل يتنبأ. كل طريق يكشف دليلاً مختلفاً.",
	"tutorial.step2.title": "اتبع الصدى",
	"tutorial.step2.body": "ابحث عن تفاعل متوهج، واقرأ نتيجته، وأخبر فريقك بما تغيّر.",
	"tutorial.step3.title": "اجمع الشظية",
	"tutorial.step3.body": "الأصداء المحلولة تكشف شظايا الذاكرة. احتفظ بالشظية المناسبة لفتحة المرساة.",
	"tutorial.step4.title": "ابنِ المرساة",
	"tutorial.step4.body": "ضع الشظايا المتوافقة بالترتيب. قد تغيّر أفعالك المتأخرة خطاً زمنياً آخر.",
	"tutorial.step5.title": "احمِ الاستقرار",
	"tutorial.step5.body": "استخدم التلميحات والدردشة والإشارات عندما يتحول مقياس الكارثة إلى الخطر.",
	"common.got_it": "أنا مستعد",
	"settings.audio": "الصوت",
	"settings.master": "الصوت العام",
	"settings.music": "الموسيقى",
	"settings.sfx": "المؤثرات الصوتية",
	"settings.ambient": "الأجواء المحيطة",
	"settings.gameplay": "اللعب وإمكانية الوصول",
	"settings.vibration": "اهتزاز التفاعل",
	"settings.screen_shake": "اهتزاز الشاشة",
	"settings.reduced_motion": "حركة منخفضة",
	"settings.subtitles": "الترجمة النصية",
	"settings.visuals": "المظهر",
	"settings.quality": "جودة الرسوم",
	"settings.low": "منخفضة",
	"settings.medium": "متوسطة",
	"settings.high": "عالية",
	"settings.ultra": "فائقة",
	"settings.fullscreen": "ملء الشاشة",
	"settings.language_section": "اللغة",
	"settings.reset": "إعادة الإعدادات الافتراضية",
	"lobby.subtitle": "اجمع فريقك. اختر عصرك. غيّر المستقبل.",
	"lobby.join_title": "أدخل إلى غرفة",
	"lobby.open_rooms": "الغرف المفتوحة",
	"story.title": "آخر رنين",
	"story.subtitle": "رحلة قصصية طويلة عبر اثني عشر فصلاً متشظياً",
	"story.intro": "مدينة تفقد ذكرياتها. اعبر الشق، وحل ألغازها، وقرر ما يستحق النجاة.",
	"story.chapters": "اختيار الفصل",
	"story.journal": "سجل الفصل الحالي",
	"story.begin": "ابدأ الفصل",
	"story.progress": "التقدم: {done}/{total}",
	"story.objectives": "أهداف الفصل",
	"story.echoes": "الأصداء المسجلة: {count}",
	"story.return": "العودة إلى الرحلة"
}
